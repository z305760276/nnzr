...
import { ShieldAlert, Construction, AlertTriangle } from 'lucide-react';
          ...
          {scoreItems.map((item, i) => (
            ...
            >
              ...
              <div className="mt-3 dark-card bg-[var(--card-inner-bg)] border border-dashed border-[var(--border-light)] rounded-lg p-4 flex items-center gap-3">
                ...
                <span className="text-[#E31837] text-xs font-medium">【待补充】完整记分细则、申诉流程、复岗考核标准。内容正在由安全稽查主管整理中，预计2026年Q2完成录入。</span>
              </div>
            </AccordionItem>
          ))}
        </AccordionGroup>
        ...
        <div className="mt-6 bg-[rgba(200,16,46,0.03)] border border-[rgba(200,16,46,0.08)] rounded-xl p-4">
          <div className="flex items-center gap-3">
            ...
            <p className="text-xs text-white">
              本模块收录中燃集团HSE安全记分管理制度全文及客户服务部执行细则。内容正在由安全稽查主管整理中，预计2026年Q2完成录入。当前记分清零周期为每年1月1日。员工对记分有异议可在7个工作日内向安全稽查主管提出申诉。
            </p>
          </div>
        </div>
      </div>
